...
function buildFieldDiagramSvg() {
  ...
  parts.push(
    turfPattern({
      x: screenX(0),
      y: screenY(ENDZONE_YD),
      width: fieldW,
      height: PLAYING_FIELD_YD * PX_PER_YARD,
  ...
  // Bewusst nicht über turfPattern (das bandet nur zeilenweise) — die
  // Endzonen sollen ihr eigenes, diagonales Muster behalten.
